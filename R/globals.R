...
# params
data("cv_today_reduced", envir = environment())
data("cv_large_countries", envir = environment())
data("cv_aggregated", envir = environment())
data("plot_map", envir = environment())
data("worldcountry", envir = environment())
data("cv_cases_global", envir = environment())
data("cv_cases_continent", envir = environment())
data("cv_cases", envir = environment())
data("cv_states", envir = environment())
...
#
# # creat cv base map
# basemap <- leaflet::leaflet(plot_map) %>%
#   addTiles() %>%
#   addLayersControl(
