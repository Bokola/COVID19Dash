...
shiny app. I was already working on a personal project that modularized
parts of the said app into a golem framework and so it was easier adding
a prediction modelling capabilities rather than starting a new project.
The \href{https://github.com/Bokola/COVID19Dash}{COVID19Dash} app can be
cloned from github and run seamlessly. For predictions look at the
...
\midrule
\textcolor[HTML]{012d4a}{\textbf{\cellcolor{gray!10}{Beta (Transmission)}}} & \textcolor[HTML]{FF5F00}{\textbf{\cellcolor{gray!10}{0.5159}}}\\
\textcolor[HTML]{012d4a}{\textbf{Gamma (Recovery)}} & \textcolor[HTML]{FF5F00}{\textbf{0.4663}}\\
\textcolor[HTML]{012d4a}{\textbf{\cellcolor{gray!10}{Basic Reproduction (R0)}}} & \textcolor[HTML]{FF5F00}{\textbf{\cellcolor{gray!10}{1.1065}}}\\
\bottomrule
\end{tabular}
\end{table}
...
\pandocbounded{\includegraphics[keepaspectratio]{aphrc-report_files/figure-pdf/unnamed-chunk-5-1.pdf}}
